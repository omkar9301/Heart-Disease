...
def prdict_heart_disease(list_data):
    ...
    X = df[['age','sex','bp','pulset','height','weight','bmi','spo2','temp','resprate','wbc','plat','hb','hba1c','cho']]
    # age,sex,bp,pulset,height,weight,bmi,spo2,temp,resprate,wbc,plat,hb,hba1c,cho,
    y = df['target']
    X_train, X_test, y_train, y_test = train_test_split(X, y, train_size=0.8, random_state=0)
    nn_model = RandomForestClassifier(n_estimators=100,learning_rate=1.0,max_depth=1, random_state=0)
